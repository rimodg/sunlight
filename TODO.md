...
**Current commit on main:** `416d11e`
...
- [ ] **16. Sub-task 2.3.3 — Corpus expansion, French PNF CJIPs.** Extract 8-12 French PNF CJIP cases from 2017-2025. Target cases: HSBC 2017, Société Générale 2018, Airbus 2020, Bolloré 2021, Bolloré 2023, McDonald's France 2022, Google France 2019, and others. Estimate: 5-8 hours research.  In progress: 7/12 French PNF cases extracted (Airbus 2020 EUR 2.083B, Bolloré 2021 EUR 12M Togo ports, Société Générale 2018 EUR 250.15M Libya, Egis Avia 2019 EUR 2.6M Algeria, Bouygues/Linkcity 2023 EUR 7.964M Annecy hospital, Airbus 2022 EUR 15.856M Libya/Kazakhstan follow-on, Paprec Group 2025 EUR 17.538M waste management cartel + favoritism + corruption + money laundering — first multi-charge CJIP in corpus, first PNF concurrence-law CJIP, structural parallel to WB INT CRBC cartel pattern). FR PNF slice now 7 cases at parity with WB INT, spanning 7 sectors, conduct topology coverage now includes cartel/favoritism (previously only in WB INT slice). HSBC Private Bank Suisse 2017 evaluated and excluded per dimensional relevance filter — underlying conduct is aggravated laundering of tax fraud proceeds, not procurement bribery; out of scope for SUNLIGHT statistical calibration. Foundational French CJIP case for legal-precedent reference only.
- [ ] **17. Sub-task 2.3.4 — Corpus expansion, World Bank INT Sanctions Board.** Extract 10-15 World Bank INT Sanctions Board cases from recent fiscal years. Administrative-sanctionable at "more likely than not" standard. Estimate: 6-10 hours.  In progress: 7/15 World Bank INT cases extracted (SNC-Lavalin 2013 Padma Bridge 10y→8y, Alstom Hydro France 2012 Zambia hydropower USD 9.5M, Siemens AG 2009 global multi-institutional USD 100M, Macmillan Limited 2010 Sudan MDTF education 6y, Alcatel-Lucent 2015 Iraq Emergency PSD telecommunications 18mo, CRBC/NRIMP1 cartel 2009 Philippines roads 8y for CRBC plus 6 firms and 1 individual, Oxford University Press 2012 East Africa textbooks 3y for OUPEA+OUPT with USD 500K restitution and parallel SFO GBP 1.9M civil recovery — establishes second within-sector comparison in corpus alongside Macmillan and second WB INT-to-UK SFO cross-prosecutor referral pattern). WB INT slice now 7 cases, 6 sectors, duration range 18 months to permanent, three conduct topologies, FIRST within-sector diversity data point.
