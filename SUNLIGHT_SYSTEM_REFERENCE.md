...
Four workstreams govern the next phase of work, and they are sequenced.

First, complete the canonical document update and close the engineering arc. The jurisdiction profile architecture (commits d453edd through 91ff35d) and the living standard infrastructure (commits 2d3b4fe and b05f73f) are shipped. Nine commits on main represent the full architectural closure. This reference document reflects the shipped state and replaces all prior versions. No further engineering is required before the research phase begins.
